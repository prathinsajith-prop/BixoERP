                ...
                {filtered.map((c) => (
                  <tr key={c.id} className="hover:bg-gray-50 cursor-pointer">
                    ...
                    <td className="px-4 py-3 text-sm text-right text-gray-900">
                      {c.creditLimit.currency} {c.creditLimit.amount.toLocaleString()}
                    </td>
                    <td className="px-4 py-3">
                      <span className={`inline-flex px-2 py-0.5 rounded-full text-xs font-medium ${c.isActive ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-500"}`}>
