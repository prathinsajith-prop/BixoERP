...
const Icons = {
    ...
    spinner: <svg className="h-7 w-7 animate-spin text-[var(--gogo-primary)]" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>,
                ...
                <div className="space-y-2">
                    {multiline ? (
                        <textarea
                            ...
                            className="w-full rounded-lg border border-[var(--gogo-primary)] px-3 py-2 text-sm text-gray-900 outline-none ring-2 ring-[var(--gogo-primary-light,_#f3e6f2)] focus:ring-[var(--gogo-primary-light,_#e8d0e7)] dark:border-[var(--gogo-primary)] dark:bg-gray-800 dark:text-white"
                        />
                    ) : (
                        <input
                            autoFocus
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-[var(--gogo-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--gogo-primary)] dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        />
                    </div>
                    <div>
        ...
        return (
            <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-gray-50 dark:bg-gray-950">
                ...
                <button onClick={() => router.push('/admin/organizations')}
                    className="inline-flex items-center gap-1 text-sm font-medium transition hover:opacity-80" style={{ color: 'var(--gogo-primary)' }}>{Icons.back} Back to organizations</button>
            </div>
        );
    }
                    ...
                    <div>
                        ...
                        {loadingMembers ? (
                            ...
                            <div className="flex flex-col items-center justify-center gap-3 rounded-2xl bg-white py-20 shadow-sm ring-1 ring-gray-100 dark:bg-gray-900 dark:ring-gray-800">
                                ...
                                <button onClick={() => setShowInvite(true)} className="text-sm font-medium transition hover:opacity-80" style={{ color: 'var(--gogo-primary)' }}>
