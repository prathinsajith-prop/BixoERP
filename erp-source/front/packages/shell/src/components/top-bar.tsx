    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-50 mt-1 w-72 rounded-xl bg-white py-2 shadow-xl ring-1 ring-gray-200/60 dark:bg-gray-800 dark:ring-gray-700">
          ...
          <a href="/organization/new" className="flex items-center gap-2.5 px-3 py-2 text-sm font-medium text-blue-600 transition hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-900/20">
