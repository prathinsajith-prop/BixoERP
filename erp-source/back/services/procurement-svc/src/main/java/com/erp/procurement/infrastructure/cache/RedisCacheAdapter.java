package com.erp.procurement.infrastructure.cache;

import com.erp.procurement.application.port.CachePort;
...
public class RedisCacheAdapter implements CachePort {
    ...
    private static final String KEY_PREFIX = "procurement:";
