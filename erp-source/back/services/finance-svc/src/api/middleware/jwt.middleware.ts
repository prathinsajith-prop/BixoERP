 ...
 * Re-validates the JWT at the service level (the gateway already validated it once).
 * Rule #7: JWT validated at the API Gateway AND re-validated at every service.
 */
@Injectable()
