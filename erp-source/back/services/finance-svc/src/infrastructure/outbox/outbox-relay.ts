...
/**
 * Outbox Relay: polls the outbox table and publishes unprocessed events to Kafka.
 * This ensures no events are lost — they are written in the same DB transaction
 * as the business write, then asynchronously relayed to Kafka.
 */
@Injectable()
